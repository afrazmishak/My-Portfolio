...
function MyTable() {
  const Understanding = [
    ...
    },
    {
      ...
      paragraphOne: "Faith in Islam is built upon six essential beliefs that give a Muslim a strong heart, a peaceful mind, and complete trust in Allah in every situation, whether it is easy or difficult.",
      points: [
  ...
  return (
    <table border="1" style={{ width: "80%", margin: "20px auto", textAlign: "center" }} className="UnderstandingTable">
      <thead>
        <tr>
          <th style={{ width: "25%" }} className="TableHead">The Foundations of Islam</th>
      ...
      <tbody>
        {Understanding.map((item, index) => (
          <tr key={index}>
            <td className="TableTopic"><b>{item.heading}</b></td>
                ...
                <ul className="TableUnListed">
                  ...
                  {item.points.map((point, i) => {
                    if (item.heading === "The Five Pillars of Islam") {
                      ...
                      const restOfTheSentence = point.substring(firstWord.length);
